                        ...
                        <Card className="mb-4">
                            ...
                            <Card.Body>
                                ...
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control type="email" name="email" value={settings.email}
                                                  onChange={handleInputChange} />
                                </Form.Group>
                                <Form.Group className="mb-3">
                                    <Form.Label>Phone</Form.Label>
                                    <Form.Control type="tel" name="phone" value={settings.phone}
                                                  onChange={handleInputChange} />
                                </Form.Group>
                                <Form.Group className="mb-3">
                                    <Form.Label>Address</Form.Label>
                                    <Form.Control type="text" name="address" value={settings.address}
                                                  onChange={handleInputChange} />
                                </Form.Group>
                            </Card.Body>
                        </Card>
